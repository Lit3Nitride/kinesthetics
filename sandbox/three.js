...
var lights = []
lights[0] = new THREE.SpotLight(0xffffff, 0.15, 0)
lights[1] = new THREE.SpotLight(0xffffff, 0.05, 0)
lights[2] = new THREE.SpotLight(0xffffff, 0.25, 0)
...
var hydrogenGeometry = new THREE.SphereGeometry(0.75, 32, 32),
...
var dipoleDirection0 = new THREE.Vector3(-1,0,0),
    dipoleDirection1 = new THREE.Vector3(1,0,0),
       ...
       dipoleArrow0 = new THREE.ArrowHelper(dipoleDirection0, origin, 3.5, 0xFFFFFF, 0.35, 0.15),
       dipoleArrow1 = new THREE.ArrowHelper(dipoleDirection1, origin, 3.5, 0xFFFFFF, 0.35, 0.15),
...
addToState("default", dipoleArrow0.scale, "y", 0.25)
addToState("default", dipoleArrow1.scale, "y", 0.25)
...
addToState(1, camera.position, "z", 15)

addToState(2, boxMaterial0, "opacity", 1)
addToState(2, boxMaterial1, "opacity", 1)

addToState(2, dipoleArrow0.scale, "y", 0.75)
addToState(2, dipoleArrow1.scale, "y", 0.75)

addToState(3, dipole0.rotation, "z", Math.PI/2)
addToState(3, dipole1.rotation, "z", -Math.PI/2)
addToState(3, dipoleArrow0.scale, "y", dipoleLength)
addToState(3, dipoleArrow1.scale, "y", dipoleLength)


addToState(4, water.rotation, "x", function(t) {
  return (180-120*Math.cos(t/1000))/180*Math.PI
}, 2000)
addToState(4, water.rotation, "y", function(t) {
  return (45*Math.cos(t/1000))/180*Math.PI
}, 2000)

addToState(4, box0.position, "y", -5, 1000)
addToState(4, box1.position, "y", 5, 1000)
addToState(4, camera.position, "z", 25)
addToState(4, camera.position, "x", 4)
